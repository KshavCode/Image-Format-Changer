...
def upload() : 
    file = filedialog.askopenfilename(initialdir="C:\\Users\\PC\\Desktop", title="Select File", filetypes=(("JPG", ".jpg"), ("PNG", ".png"), ("WEBP", ".webp"), ("TIFF", ".tiff"), ("ICO", ".ico"), ("BMP", ".bmp")))
    global image
...
img11 = PhotoImage(file="downloadimg.png")
img22 = PhotoImage(file="uploadimg.png")
